  ...
  <body style="background-image: url('{{asset('/')}}/background-juara.jpeg');">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            //         window.location.href = '{{route("user.dashboard")}}'; // Ganti HALAMAN_LOGIN dengan URL halaman login
            //     else
            //         window.location.href = '{{route("pilih.tahun.anggaran")}}'; // Ganti HALAMAN_LOGIN dengan URL halaman login
            // }
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            fetch('{{route("login")}}', {
                ...
                .then(data => {
                    ...
                    window.location.href = '{{route("pilih.tahun.anggaran")}}';
                })
                .catch(error => {
